...
mainBackgroundPath(Canvas canvas, Size size,Paint paint){
  ...
  mainBGPath.quadraticBezierTo(firstControlPoint.dx, firstControlPoint.dy, firstEndPoint.dx, firstEndPoint.dy);

  var secondControlPoint = Offset(size.width - (size.width / 3.50), size.height + (size.height / 3.50));
  var secondEndPoint = Offset(size.width, size.height +(size.height / 20) );
  mainBGPath.quadraticBezierTo(secondControlPoint.dx, secondControlPoint.dy, secondEndPoint.dx, secondEndPoint.dy);
...
secondBAckgroundPath(Canvas canvas, Size size,Paint paint){
  ...
  mainBGPath.quadraticBezierTo(size.width * .33, size.height * .3, 0, size.height/1.5);
...
purpleBackgroundPath(Canvas canvas, Size size,Paint paint){
  ...
  purplePath.quadraticBezierTo(size.width * .33, size.height * .3, 0, size.height/1.5);

  purplePath.lineTo(size.width/2.25, size.height);

  var secondControlPoint = Offset(size.width - (size.width / 3.50), size.height + (size.height / 3.50));
  var secondEndPoint = Offset(size.width, size.height +(size.height / 20));
  purplePath.quadraticBezierTo(secondControlPoint.dx, secondControlPoint.dy, secondEndPoint.dx, secondEndPoint.dy);
  ...
  purplePath.quadraticBezierTo(firstControlPoint.dx, firstControlPoint.dy, firstEndPoint.dx, firstEndPoint.dy);
  purplePath.close();
